...
class FusionComponent(nn.Module):
    ...
    def __init__(self, in_channels1, in_channels2, out_channels):
        ...
        self.conv3_1 = Conv(c1=out_channels, c2=32, k=6, s=2, p=2)
...
class Ensemble(nn.ModuleList):
    ...
    def forward(self, x1, augment=False, profile=False, visualize=False):

        return self.fusion_component(x1)


def new_forward(self, x1, x2,x3):
    x = fusion_component(x1, x2,x3)
